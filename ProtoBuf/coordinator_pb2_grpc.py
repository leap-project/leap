...
class SiteCoordinatorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RegisterAlgo = channel.unary_unary(
        ...
        request_serializer=coordinator__pb2.SiteAlgoRegReq.SerializeToString,
        response_deserializer=coordinator__pb2.SiteAlgoRegRes.FromString,
        )
...
def add_SiteCoordinatorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RegisterAlgo': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=coordinator__pb2.SiteAlgoRegReq.FromString,
          response_serializer=coordinator__pb2.SiteAlgoRegRes.SerializeToString,
      ),
  }
...
class CloudCoordinatorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RegisterAlgo = channel.unary_unary(
        ...
        request_serializer=coordinator__pb2.CloudAlgoRegReq.SerializeToString,
        response_deserializer=coordinator__pb2.CloudAlgoRegRes.FromString,
        )
    self.Compute = channel.unary_unary(
        '/protoBuf.CloudCoordinator/Compute',
        request_serializer=computation__pb2.ComputeRequest.SerializeToString,
        response_deserializer=computation__pb2.ComputeResponses.FromString,
        )
...
def add_CloudCoordinatorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RegisterAlgo': grpc.unary_unary_rpc_method_handler(
          servicer.RegisterAlgo,
          request_deserializer=coordinator__pb2.CloudAlgoRegReq.FromString,
          response_serializer=coordinator__pb2.CloudAlgoRegRes.SerializeToString,
      ),
      'Compute': grpc.unary_unary_rpc_method_handler(
          servicer.Compute,
          request_deserializer=computation__pb2.ComputeRequest.FromString,
          response_serializer=computation__pb2.ComputeResponses.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
