...
#
## Create configs
#bash ${leap_dir}/evals/utils/create-configs.sh ${leap_dir}
#
#git add ${leap_dir}/.
#git commit -m "Updating configs and certificates"
#git push
#
#bash ${leap_dir}/evals/utils/pull-all.sh ${leap_dir}/evals/ips/site-ips ${leap_dir}/evals/ips/client-ips ${leap_dir}/evals/ips/cloud-ips $user master