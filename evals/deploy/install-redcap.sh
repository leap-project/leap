...
# Create super token
sudo mysql -u root -p"password" -Bse "USE redcap; UPDATE redcap_user_information SET api_token = 'FEJRQVHQ3993BYQ50KMXZ0XFQH17V3X5P5STELNZ2DE243EUKJDY4T2O12GZ5555' WHERE username='site_admin';"
